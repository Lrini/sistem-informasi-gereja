...
?>				
				...
				<?php
					...
					$edit	="UPDATE tb_jab_detail SET  id_jemaat='$nama_jemaat',
						...
						if($edit){
								echo "<script>alert('Data Berhasil Diupdate'); window.location = 'admin/majelis.php'</script>";
								
							}else{
								echo "<script>alert('Data Gagal Diupdate!!'); window.location = 'admin/majelis.php'</script>";
