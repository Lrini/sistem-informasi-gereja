...
<div id="tooplate_wrapper">
    ...
    <div id="tooplate_main">
		...
		<hr>
		<?php
				$query  = "SELECT * FROM tb_galery order by id_galery desc";
				$tampil = mysqli_query($konek, $query);

				$kolom = 5; // Tentukan banyaknya kolom horizontal
			...
			echo "<td align=\"center\"><br>
				<a href=\"galery_detail.php?id_galery=$r[id_galery]\"><img width=\"150px\" height=\"90px\"src=\"images/$r[gambar]\" border=\"0\">
					</td>";
				}
			echo "</tr></table>";
		?>
