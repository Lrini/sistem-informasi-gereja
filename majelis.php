...
<div id="tooplate_middle">
    ...
    <div id="tooplate_main">
		...
		<br><br><br><br><br>
			...
			if (isset ($_POST ['renungan'])) {
			$nama_rayon =$_POST['renungan'];
		//	$query  =;
			$tampil = mysqli_query($konek, "Select * from tb_pelayanan join tb_jemaat on tb_pelayanan.id_jemaat=tb_jemaat.id_jemaat where tb_pelayanan.status='$nama_rayon' ");
