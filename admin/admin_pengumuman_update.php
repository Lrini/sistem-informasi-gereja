    ...
    <div id="tooplate_main">
        ...
        <div class="col_w900 col_w900_last">
			  ...
			  <?php
				...
				?>
				<form method="POST" action="admin_pengumuman_update_aksi.php" enctype="multipart/form-data">
					<table>
						<tr>
							<th></th>
							<td></td>
						...
						<tr>
							...
							<td>
								<?php
									echo "<input name='sts_peng' type='radio' value='Y'"; if($r['sts_peng']=='Y'){ echo "checked";} echo "/>Ya";
									echo "<input name='sts_peng' type='radio' value='N'"; if($r['sts_peng']=='N'){ echo "checked";} echo "/>Tidak";
									?>
