...
<div id="tooplate_wrapper">
    ...
    <div id="tooplate_main">
		...
		<center>
			...
			$query = "select * from tb_jemaat order by id_jemaat LIMIT $posisi,$batas";
			...
			echo"<table font weight=bold width=900px>
				...
				echo "<td align=center>$r[id_jemaat]</td>
					...
					<td align=center><a href =jemaat_detail.php?id_jemaat=$r[id_jemaat]>Detail<br></a>
					   <a href =jemaat_update.php?id_jemaat=$r[id_jemaat]>Update</a>   
				</tr>";
				$no++;
			}
			echo "</table>";
