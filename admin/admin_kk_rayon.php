		...
		<center>
			...
			echo"<table font weight=bold width=900px>
				...
				echo "<td><center>$r[id_kk]</center></font></td>
					<td>$r[nama_kk]</td>
					<td align=center> <a href =admin_tambah_jemaat_rayon.php?id_kk=$r[id_kk]>Update</a>
						<br><a href =admin_kk_delete_rayon.php?id_kk=$r[id_kk]>Delete</a></td>
				</tr>";
				$no++;
			}
			echo "</table>";
			//langkah :  hitung total  data halaman serta link
			$query2		= mysqli_query($konek,"select * from tb_kk");
