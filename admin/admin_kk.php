...
<div id="tooplate_wrapper">
    ...
    <div id="tooplate_main">
		...
		<center>
			...
			$query  = "SELECT * FROM tb_kepalai LIMIT $posisi,$batas";
			...
			$query2		= mysqli_query($konek,"select * from tb_kepalai");
			...
			echo"<br> Halaman : ";
				for($i=1; $i<=$jmlhalaman;$i++)
					if($i != $halaman){
						echo" <a href=\"kk.php?halaman=$i\">$i</a> | ";
					}
					else{ echo"<b>$i</b>|";}
