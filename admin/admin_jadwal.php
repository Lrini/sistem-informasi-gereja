    ...
    <div id="tooplate_main">
		...
		<center>
			...
			echo"<table font weight=bold width=900px>
				...
				$tampil = mysqli_query($konek, "SELECT * FROM tb_jadwal,tb_rayon where tb_jadwal.id_rayon=tb_rayon.id_rayon LIMIT $posisi,$batas");
				$no=$posisi+1;
			...
			echo"<br> Halaman : ";
				for($i=1; $i<=$jmlhalaman;$i++)
					if($i != $halaman){
						echo" <a href=\"jadwal.php?halaman=$i\">$i</a> | ";
					}
					else{ echo"<b>$i</b>|";}
