...
<div id="tooplate_wrapper">
	...
	<div id="tooplate_middle2">
    	<div id="middle_left1">
            <div id="site_title">
				<a href="admin_tambah_jadwal_rayon.php">-+Tambah Data Jadwal - </a>
				<a href="admin_cetak_jadwal_rayon.php" target=_blank>- Cetak Data Jadwal - </a>
			</div>
        </div>
		...
		<center>
			...
			echo"<table font weight=bold width=900px>
				...
				echo "<td align=center>$r[id_ibadah]</td>
					...
					<td align=center> <a href =admin_jadwal_update_rayon.php?id_jadwal=$r[id_jadwal]>Update</a><br>
						<br><a href =admin_jadwal_delete_rayon.php?id_jadwal=$r[id_jadwal]>Delete</a></td>
				</tr>";
				$no++;
			}
			echo "</table>";
