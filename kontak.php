...
<div id="tooplate_wrapper">
		 ...
		 <li><a href="#" ><font color="black">Data</a></font>
		  ...
		  <li><a href="#" ><font color="black">Pengumuman</a></font>
			<ul>
				...
				<br>
				<br>
				<li><a href="" class="Ulang Tahun"><font color="black">Ulang Tahun Kelahiran</a></li>
			</ul>
			</li>
		  
		  
		    <li><a href="#"><font color="blue">Info</a></font>
		 <ul>
				<li><a href="Profil.php" class="profil1" ><font color="black">Profil Gereja</a></li>
				<Br>
				<br>
				<li><a href="kontak.php"class="kontak"><font color="blue">Kontak</a></li>
				<br>
			</ul>
			</li>
    ...
    <div id="tooplate_main">
        ...
        <div class="col_w900 col_w900_last">
			...
			<hr>
			<font color=white>
			<p>Nama			:	GMIT Bet'El Maulafa - Klasis Kupang Tengah</p>
			<p>Alamat		:	Jl.Gereja Bet'El Maulafa</p>
			<p>No Telp		:	085-239-202-115</p>
			<p>Alamat Email	:	yakob.arianto@yahoo.com</p>
