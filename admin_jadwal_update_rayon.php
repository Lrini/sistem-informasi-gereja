...
<div id="tooplate_wrapper">
	<div id="tooplate_header">
		<div id="tooplate_middle1">
			<div id="site_title" =><a href="#">Halaman Admin Update Jadwal</a></div>
		</div>
    </div>
    ...
    <div id="tooplate_main">
        ...
        <div class="col_w900 col_w900_last">
			  ...
			  <?php
				...
				?>
				<form method="POST" action="admin_jadwal_update_aksi_rayon.php" enctype="multipart/form-data">
					<table>
					<tr>
							<th>ID Ibadah</th>
							<td></td>
							<td><input type="text" name="id_jadwal" hidden="hidden" value="<?php echo "$r[id_ibadah]";?>"></td>
						</tr>
						<tr>
							<th>Rayon</th>
							<td>:</td>
